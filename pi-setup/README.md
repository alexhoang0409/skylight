...
once per minute. The ground request identifies itself with Skylight's project URL;
override the provider or contact identifier with `GROUND_API_URL` or
`GROUND_USER_AGENT` if needed. If you later add an RTL-SDR, run:
